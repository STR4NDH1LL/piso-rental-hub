        ...
        <div className="prose prose-gray max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Welcome to Piso ("we," "our," or "us"). We are committed to protecting your privacy and personal information. 
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our 
              rental management platform and services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-semibold mb-3">2.2 Information We Collect Automatically</h3>
            <ul className="list-disc pl-6 text-muted-foreground mb-4 space-y-1">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-muted-foreground mb-4 space-y-1">
              <li>Provide and maintain our rental management services</li>
              <li>Process payments and transactions</li>
              <li>Facilitate communication between renters and tenants</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-muted-foreground mb-4 space-y-1">
              <li><strong>With Other Users:</strong> Information necessary for rental relationships (e.g., contact details between renters and tenants)</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              the updated policy on our platform and updating the effective date.
            </p>
          </section>
